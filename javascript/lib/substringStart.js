/**
 * Cuts from the start of a string by character index or string.
 * 
 * @param {String} str The string to cut.
 * @param {Number|String} search The index of the last character to cut up to, or a string to look for from the start of the string.
 * 
...
var substringStart = function (str, search) {
    ...
    try {
        ...
        if (typeof search == "number") {
            return str.substring(search, str.length);
        } else {
